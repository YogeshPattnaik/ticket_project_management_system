      ...
      if (id === '\0virtual:react') {
        return `
          ...
          if (typeof window !== 'undefined' && window.__REACT__) {
            console.log('[analytics-mfe] Using host React via plugin');
          } else {
            console.log('[analytics-mfe] Using local React (host not available)');
          }
      ...
      if (id === '\0virtual:react-dom') {
        return `
          ...
          if (typeof window !== 'undefined' && window.__REACT_DOM__) {
            console.log('[analytics-mfe] Using host ReactDOM via plugin');
          }
      ...
      if (id === '\0virtual:react-dom/client') {
        return `
          ...
          if (typeof window !== 'undefined' && window.__REACT_DOM__ && typeof window.__REACT_DOM__.createRoot === 'function') {
            ...
            console.log('[analytics-mfe] Using local ReactDOM (host not available or invalid)');
          }
